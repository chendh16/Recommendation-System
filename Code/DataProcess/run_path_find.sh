...
cp data/output/*.translated ../songPathRnn/data/input/
cp data/output/path_rnn_test_samples_0.0.txt ../songPathRnn/data/input/
cp data/output/path_rnn_test_samples_0.0.txt ../songPathRnn/eval/test_samples/
